...
export const projects = [
  {
    ...
    cardSummary: [
      ...
      "판매/정산 엑셀 10만 행 이상 업로드도 1~2분 내 처리",
    ],
    ...
    readme: {
      ...
      meaning:
        "프론트엔드 전담으로 핵심 도메인 화면을 직접 설계/구현하며, 단순 UI 제작이 아니라 실제 업무 흐름을 제품 화면으로 구조화하는 경험을 했습니다. 헤더/라인 입력 UX 재구성과 자체 유효성 검증으로 전표 1건 처리 시간을 ERP 2~3분 → PioSync 1분 내외로 줄였고, 반복 전표는 일괄삽입으로 10건당 1초 수준 처리했습니다. 또한 판매/정산 엑셀 10만 행 이상 업로드도 1~2분 내 처리하도록 구현했습니다. API 연동 이슈를 백엔드와 함께 추적해 요청/응답 검증 기준과 오류 처리 루틴을 정리했고, 운영 피드백을 주기 배포에 반영하면서 기능 확장과 안정성의 균형을 체득했습니다.",
      features: [
